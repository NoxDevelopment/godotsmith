...
# Force ComfyUI:
python3 ${CLAUDE_SKILL_DIR}/tools/asset_gen.py image \
  --prompt "the full prompt" --backend comfyui -o assets/img/car.png

# Force Gemini:
python3 ${CLAUDE_SKILL_DIR}/tools/asset_gen.py image \
  --prompt "the full prompt" --backend gemini -o assets/img/car.png

# Custom checkpoint (ComfyUI only):
python3 ${CLAUDE_SKILL_DIR}/tools/asset_gen.py image \
...
```bash
python3 ${CLAUDE_SKILL_DIR}/tools/asset_gen.py list_models
```
